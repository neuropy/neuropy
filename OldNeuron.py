"""Defines the Neuron class. This could be split up into multiple base classes
(one for basic init and loading NeuronBase), one for rates (NeuronRate), one for codes (NeuronCodes), etc...), and then combined
using multiple inheritance into a single child Class called Neuron"""
