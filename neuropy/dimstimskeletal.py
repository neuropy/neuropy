...
class Dimension(object):
    """An experiment dimension, all of whose Variables covary"""
    ...
    def __len__(self):
        ...
        # assumes all vars in this dim have the same number of conditions:
        return len(list(self.variables.values())[0])
