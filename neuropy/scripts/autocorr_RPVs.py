...
should help demonstrate that even in the worst case scenario, the autocorr isn't a great poor
...
for tracki, (track, c) in enumerate(zip(tracks, colours)):
    ...
    print(farr)
    plot(farr['df'], ls='-', lw=4, marker=None, c=c, label='track %d' % (tracki+1))
    farrs.append(farr)
