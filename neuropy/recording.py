...
class RecordingRaster(BaseRecording):
    ...
    def psth(self, nids=None, sweepis=None, eids=None, natexps=False, t0=None, dt=None,
        ...
        convolving the spike trains collapsed across trials with a Gaussian kernel, instead of
        using purely square bins. norm==True normalizes the PSTH max to 1 for arbitrary units,
        norm='ntrials' normalizes by number of trials, and norm=False does no normalization. c
        controls color, and can be a single value, or a list of len(nids)."""
